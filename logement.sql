...
-- Table represente les factures aliment quel logement:
--CREATE TABLE FacLog (idFac INTEGER NOT NULL, idLoge INTEGER NOT NULL, FOREIGN KEY (idFac) REFERENCES Facture(id), FOREIGN KEY (idLoge) REFERENCES Logement(id), PRIMARY KEY (idFac,idLoge));
